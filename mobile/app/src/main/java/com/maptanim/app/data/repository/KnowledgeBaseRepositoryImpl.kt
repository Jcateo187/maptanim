...
internal val defaultPestGuides = listOf(
    PestGuide(
        ...
        affectedCrops = listOf("Tomato", "Eggplant", "Corn", "Okra", "Chili Pepper"),
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Tomato", "Chili Pepper", "Squash"),
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Cabbage", "Pechay"),
        category = "Insect Pest",
        organicControl = "Apply Bt (Bacillus thuringiensis) kurstaki strain every 5–7 days. Intercrop with onions as repellent.",
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Onion", "Chili Pepper", "Cabbage", "Cucumber"),
        category = "Insect Pest",
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Eggplant", "Chili Pepper", "Cucumber", "Lettuce"),
        category = "Insect Pest",
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Pechay", "Tomato", "Cucumber", "Kangkong"),
        category = "Insect Pest",
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Eggplant", "Pechay", "Tomato", "Cabbage"),
        category = "Insect Pest",
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Tomato", "Eggplant", "Chili Pepper", "Squash"),
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Cucumber", "Ampalaya", "Squash"),
        category = "Fungal Disease",
    ...
    PestGuide(
        ...
        affectedCrops = listOf("Chili Pepper", "Tomato", "Eggplant"),
        category = "Fungal Disease",
...
internal val defaultSoilGuides = listOf(
    SoilGuide(
        ...
        bestCrops = listOf("Tomato", "Eggplant", "Chili Pepper", "Carrot", "Onion", "Lettuce", "Corn", "Squash"),
    ...
    SoilGuide(
        ...
        bestCrops = listOf("Carrot", "Chili Pepper", "Onion", "Tomato", "Eggplant"),
    ...
    SoilGuide(
        ...
        bestCrops = listOf("Lettuce", "Cabbage", "Kangkong", "Pechay"),
    ...
    SoilGuide(
        ...
        bestCrops = listOf("Okra", "Corn", "String Beans", "Squash"),
...
internal val defaultSeasonalWindows = listOf(
    ...
    SeasonalWindowInfo(
        ...
        wetSeasonStatus = "ACCEPTABLE",
        peakMonths = "Year-Round",
        notes = "High-value climbing vine; trellis structures keep fruits clean and disease-free."
    ),
    SeasonalWindowInfo(
